      ...
      <div className="right-panel">
        <div>
          <div className="description">
            I'm an experienced graphic designer that love to prototype, be
            creative and solve design problems. I’m passionate about design in
            general, but my focus right now is around the Web. At the beginning
            of 2018, I’ve started this journey to learn more and more about Web
            Design. I’ve taken a couple of courses/workshops and went to a lot
            of meetups.
          </div>
        </div>
        <div>
          ...
          <div className="connected-line">
            ...
            <div className="line">
              ...
              <div className="subtitle">INTRODUCTION TO WEB DESIGN</div>
            </div>
            <div className="line">
              <div className="circle" />
              <div className="dates">2018</div>
              <div className="title">UDEMY - SKETCH</div>
              <div className="subtitle">DESIGN OF SKETCH APPLICATIONS</div>
            </div>
            <div className="line">
              <div className="circle" />
            ...
            <div className="line">
              ...
              <div className="title">COLÉGIO INTERNATO DOS CARVALHOS</div>
